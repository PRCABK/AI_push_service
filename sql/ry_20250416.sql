...
CREATE TABLE `sys_ai_config` (
  ...
  `api_url` varchar(255) DEFAULT NULL COMMENT '�ӿڵ�ַ',
  `model_name` varchar(128) NOT NULL COMMENT 'ģ������',
  `temperature` decimal(10,2) DEFAULT NULL COMMENT '�¶Ȳ���',
  `max_tokens` int(11) DEFAULT NULL COMMENT '���Tokens',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='AIƽ̨����';
...
CREATE TABLE `sys_ai_prompt` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `prompt_name` varchar(128) NOT NULL COMMENT 'ģ������',
  `prompt_key` varchar(128) NOT NULL COMMENT '����Key',
  `scene_name` varchar(128) DEFAULT NULL COMMENT '��������',
  `scene_code` varchar(64) DEFAULT NULL COMMENT '��������',
  `ai_config_id` bigint(20) DEFAULT NULL COMMENT 'Ĭ��AI����',
  `content` text NOT NULL COMMENT 'Prompt����',
  `remark` varchar(500) DEFAULT NULL,
  `create_by` varchar(64) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_by` varchar(64) DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='��ʾ��ģ��';
...
CREATE TABLE `sys_wecom_config` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `config_name` varchar(64) NOT NULL COMMENT '��������',
  `corp_id` varchar(64) NOT NULL COMMENT '��ҵID',
  `secret` varchar(128) NOT NULL COMMENT '��ҵSecret',
  `agent_id` int(11) NOT NULL COMMENT 'AgentId',
  `default_user` varchar(512) DEFAULT NULL COMMENT 'Ĭ�Ͻ����û�',
  `default_party` varchar(512) DEFAULT NULL COMMENT 'Ĭ�ϲ���',
  `receiver_groups` text COMMENT '�����˷���(JSON)',
  `default_msg_type` varchar(32) DEFAULT 'text' COMMENT 'Ĭ����Ϣ����',
  `text_template` text COMMENT '�ı�ģ��',
  ...
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='����ƽ̨����';
...
CREATE TABLE `sys_push_task` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `request_id` varchar(64) DEFAULT NULL COMMENT '����ID',
  `ai_config_id` bigint(20) DEFAULT NULL COMMENT 'AI����',
  `wecom_config_id` bigint(20) DEFAULT NULL COMMENT '΢������',
  `prompt_key` varchar(128) DEFAULT NULL COMMENT '��ʾ��Key',
  `msg_type` varchar(32) DEFAULT NULL COMMENT '��Ϣ����',
  `receivers` varchar(512) DEFAULT NULL COMMENT '������',
  `receiver_group` varchar(128) DEFAULT NULL COMMENT '���շ���',
  `payload` text COMMENT '��������',
  `ai_result` text COMMENT 'AI�������',
  `status` varchar(32) DEFAULT NULL COMMENT '״̬',
  `error_msg` varchar(500) DEFAULT NULL COMMENT '������Ϣ',
